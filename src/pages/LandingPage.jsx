...
function LandingPage() {
  ...
  return (
    <>
      <div className="w-full min-w-full bg-[#FFFCEF]">
        <div className="w-[500px] h-[500px] bg-amber-200/10 blur-[65px] absolute top-0"></div>
      ...
      <div className="w-full min-h-full relative z-10">
        <div>
          <section className="flex items-center justify-center -mt-36">
            <img
              src={HEROIMG}
              className="w-[80vw] rounded-lg border border-amber-300"
              alt="Hero Image"
            />
          </section>
        </div>
