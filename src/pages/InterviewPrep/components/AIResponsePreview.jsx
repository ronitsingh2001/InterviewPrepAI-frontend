  ...
  return (
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        <button className="text-gray-600 hover:text-gray-700 focus:outline-none relative group cursor-pointer" onClick={copyCode} aria-label="Copy Code">
          {copied ? <Check className="text-green-600" size={15} /> : <Copy size={15} />}
          {copied && <span className="absolute top-8 right-0 bg-black text-white text-xs rounded-md px-2 py-1 opacity-80 group-hover:opacity-100">Copied!</span>}
        </button>
      </div>
      <Prism
        language={language}
